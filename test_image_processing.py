...
def test_svg_image():
    ...
    if not HAS_CAIROSVG:
        print("Skipping SVG test because 'cairosvg' or its Cairo system dependency is not available.")
        return
    ...
    # Process the image
    try:
        ecg_signal, _ = process_ecg_image(png_path)
...
def create_test_ecg_image():
    ...
    ecg_signal, _ = process_ecg_image(output_path)
